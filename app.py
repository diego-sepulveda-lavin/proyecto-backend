...
def email():
    ...
    if not nombre:
        return jsonify ({"msg": "Por favor ingresa tu nombre"}),401
    if not email:
        return jsonify ({"msg": "Por favor ingresa tu email"}),401
    if not consulta:
        return jsonify ({"msg": "Por favor ingresa tu constulta"}),401
